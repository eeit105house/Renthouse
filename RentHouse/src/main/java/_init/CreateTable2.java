...
public class CreateTable2 {
	...
	public void CreateTableOther(Member member,House house,HouseDetail houseDetail,HouseDeal houseDeal,
		...
		try {
			...
			houseDeal.setHouseBean(session.get(House.class, house.getId()));
	...
	public void CreateTableAllPic(Member member, House house, HouseDetail houseDetail,HouseDeal houseDeal, HousePic housePic,
