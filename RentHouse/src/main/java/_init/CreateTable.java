...
public class CreateTable {
	...
	public static void main(String[] args) throws ParseException {
		...
		java.util.Date thedate1 = sDF.parse("2018-03-02");
		java.util.Date thedate2 = sDF.parse("2018-05-05");
		java.util.Date thedate3 = sDF.parse("2018-07-02");
		java.util.Date thedate4 = sDF.parse("2018-03-05");
		 Long date = new java.util.Date().getTime();
		 Timestamp time = new Timestamp(date);
		 java.sql.Date sdate = new java.sql.Date(date); 
		 java.sql.Date sdate1 = new java.sql.Date(thedate1.getTime()); 
		 java.sql.Date sdate2 = new java.sql.Date(thedate2.getTime()); 
		 java.sql.Date sdate3 = new java.sql.Date(thedate3.getTime()); 
		 java.sql.Date sdate4 = new java.sql.Date(thedate4.getTime()); 
		...
		HouseDeal houseDeal1 = null;
		HouseDeal houseDeal2 = null;
		HouseDeal houseDeal3 = null;
		HouseDeal houseDeal4 = null;
...
//=======
		...
		try {
			...
			houseDeal1 = new HouseDeal(null,null,sdate4,null,50000,null,null);
			houseDeal2 = new HouseDeal(null,null,sdate1,null,50000,null,null);
			houseDeal3 = new HouseDeal(null,null,sdate2,null,50000,null,null);
			houseDeal4 = new HouseDeal(null,null,sdate3,null,50000,null,null);
			
			
			employee = new Employee("master03", "bbbb1234", "林二明", "staff",SystemUtils.fileToBlob("image/avatar2.jpg"));
			employeeReport1 = new EmployeeReport(null,null,null,"系統相關","遇到房屋圖片死圖",clob2,sdate,"會員未讀",null);
			employeeReport2 = new EmployeeReport(null,null,null,"系統相關","遇到房屋圖片死圖",clob1,sdate,"會員未讀",null);
		...
		new CreateTable2().CreateTableAllPic(member3, house0, houseDetail0,houseDeal3, housePic0,housePic00,housePic01,housePic02,housePic03, forumR0);
		new CreateTable2().CreateTableAllPic(member2, house1, houseDetail1,houseDeal4, housePic1,housePic10,housePic11,housePic12,housePic13, forumR1);
		new CreateTable2().CreateTableOther(member0, house2, houseDetail2,houseDeal1, housePic2, forumR2,forumReport1,forumReply1,employeeReport1,reservation1);
		new CreateTable2().CreateTableOther(member1, house3, houseDetail3,houseDeal2, housePic3, forumR3,forumReport2,forumReply2,employeeReport2,reservation2);
