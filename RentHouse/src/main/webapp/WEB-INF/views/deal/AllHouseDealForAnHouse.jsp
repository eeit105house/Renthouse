...
<table>
<tr><td>成交編號</td><td>簽約日</td><td>月租金</td><td>到期日</td><td>契約</td><td>修改內容</td></tr>
...
<td><form action="${pageContext.request.contextPath}/deal/getPdf/${houseDeal.id}" method="GET"><button type="submit">查看契約</button></form></td>
